...
const Home: NextPageWithLayout = () => {
  ...
  return <div className='m-3'>
    ...
    <Card bg='dark' className='mx-5'>
      <Card.Body>
        <Card.Text>
          Привет Бандит! Ты попал Хуйню Года™, а если быть точным то в 6-ую ежегодную стадию ежегодного Аутизма Rice Fields Хуйни Года™. Да я копирую этот текст уже 3 год...
          В этом году у нас сплошные инновации. Например Дед Мороз наконец то отменил фотошоп (для любителей <span className='roadrage'>Road Rage</span> и проприетарного программного обеспечения все еще доступны прошлогодние паки <span style={{ color: 'var(--bs-primary)' }}><a href='https://tridvaras.github.io/HG2020/'>тут</a></span>) и альбомами в гугл фото (хотя они мне нравились).
        </Card.Text>
        <Card.Text className='mb-1'>
          По давней традиции номинации описывались максимально непонятно, но теперь они с описанием (все еще непонятным). Названия категорий могут повторяться, ориентируйтесь по описанию или тегам.  Перед началом рекомендую потыкать глобальные настройки:
        </Card.Text>
